...
const int POINTS_LEFT_IN_CURVE = 135; // do not update paths with previous paths more than 10 points
...
const double SAFETY_DISTANCE = 1 * CAR_LENGTH; // how close to other vehicles to go in meters
const double SAFETY_WIDTH = CAR_WIDTH;
const int    UPDATE_EVERY = 40;                // every N consumed points I will update
...
const double WEIGHT_MAX_ACCELERATION_COST = 10.0;
const double WEIGHT_MAX_JERK_COST = 10.0;
const double WEIGHT_EFFICIENCY_COST = 110.0;
const double WEIGHT_TRAFFIC_COST = 10.0;
